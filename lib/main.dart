...
class LocalNotificationService {
  ...
  static void display(RemoteMessage event) {
...
class SharePref {
  Future<String?> getType(String key) async {
    // Logic to retrieve type from SharedPreferences
    return "user"; // Sample implementation, replace with actual logic
  }
}

class AppConstants {
  static const double screenWidget = 360.0;
  static const double screenHeight = 640.0;
}
